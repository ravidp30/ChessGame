...
public class ServerUI extends Application {
	...
	public static void main(String args[]) throws Exception {
		try {
			...
			ServerController.getInstance().disconnectBtn(); // call disconnect server function to exit the server correctly
		}
	}
	...
	public void start(Stage primaryStage) throws Exception {
		try {
		ServerController aFrame = new ServerController(); // create ServerPortFrame
