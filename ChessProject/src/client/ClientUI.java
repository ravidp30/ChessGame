...
public class ClientUI extends Application {
	...
	public static void main( String args[] ) throws Exception {
		try {
        	...
        	try {
            	chat.client.quit("-1"); // send the server message to remove the client from the connected clients and terminates the client
	...
	/**
	 ...
	 Initializes and starts the client application by creating an instance of the {@link ClientConnectController}
